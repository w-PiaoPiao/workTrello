...
_zh_en: dict[str, str] = {
    ...
    "分管": "Division head",
    "财政": "Finance bureau",
    "资金分配监视": "Fund Tracking",
    "资金分配监视泳道": "Fund tracking lane",
    "牵头类型": "Lead track",
    "启动日期": "Start date",
    "自动期限：2周期限 {d1} · 30日期限 {d2}":
        "Auto deadlines: 2-wk {d1} · 30-day {d2}",
    "清除该环节办理时间": "Clear step date",
    "资金分配流程 {done}/{total}": "Fund flow {done}/{total}",
    "全部环节已完成": "All steps completed",
    "当前：{name}": "Current: {name}",
    "资金分配监视（配合）：仅 2 次期限提醒":
        "Fund tracking (assist): 2 deadline reminders only",
    "资金分配监视：未配置环节": "Fund tracking: no steps configured",
    "环节耗时：": "Step durations: ",
    "天": "d",
    " → ": " → ",
    "流程总用时：{n} 天": "Total duration: {n} days",
    "还剩 {n} 天": "{n} days left",
    "已启用资金分配监视": "Fund tracking enabled",
    "已关闭资金分配监视": "Fund tracking disabled",
    "导出 Excel…": "Export Excel…",
    "导出资金分配记录": "Export Fund Tracking Records",
    "Excel 工作簿 (*.xlsx)": "Excel Workbook (*.xlsx)",
    "已导出 {n} 张卡片": "Exported {n} cards",
    "导出失败：{err}": "Export failed: {err}",
    "泳道内暂无资金卡片，未导出": "No fund cards in this lane; nothing exported",
    "≡ 有备注": "≡ Notes",
